...
and the time-slice error $\|u_0 - \gamma_0 u^{\udelta \delta}\|_{L_2(\Omega)}$ at $t=0$.
...
\begin{figure}
  ...
  \caption{Error progression of $e^\delta := u - u^{\underline{\delta}\delta}$ as
...
corner.\jw{hier wil ik een citatie of *iets* anders} Figure~\ref{fig:cylinder}

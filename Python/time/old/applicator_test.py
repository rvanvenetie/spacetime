    ...
    for basis in [
        ...
        for l in range(1, 6):
            ...
            for _ in range(10):
                ...
                assert np.allclose([(1.0 if index[0] == 0 else 2**
                                     (index[0] - 1)) * res[index]
    ...
    for basis in [
        ...
        for l in range(1, 6):
            ...
            for _ in range(10):
                ...
                res = applicator.apply(SparseVector(Lambda, vec))
...
def test_multiscale_operator_quadrature():
    ...
    for basis_in, basis_out, operator, deriv in [
        ...
        for i, labda in enumerate(Lambda_in):
            ...
            vec = SparseVector(Lambda_in, eye[i, :])
            res = applicator.apply(vec)
...
def test_apply_upp_low_vs_full():
    ...
    for basis in [
        ...
        for _ in range(10):
            c = SparseVector(Lambda, np.random.rand(len(Lambda)))

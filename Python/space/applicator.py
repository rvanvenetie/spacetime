...
class Applicator:
    ...
    def apply(self, vec_in, vec_out):
        ...
        vec_in_new = TreeVector(vec_in.node)
        ...
        vec_out_new = TreeVector(vec_out.node)
    ...
    def to_matrix(self, Lambda_in, Lambda_out):
        ...
        for i, psi in enumerate(nodes_in):
            ...
            vec_in = Lambda_in.deep_copy(mlt_node_cls=NodeVector,
                                         mlt_tree_cls=TreeVector)
            for n in vec_in.bfs():
                if n.node == psi.node:
                    n.value = 1
                    break
            ...
            vec_out = Lambda_out.deep_copy(mlt_node_cls=NodeVector,
                                           mlt_tree_cls=TreeVector)
